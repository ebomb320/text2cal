...
function parseText(raw) {
  ...
  // Who: look for person keywords. NOTE — this matches the four starter
  // member ids (family/me/wife/kids). If you rename or add family members,
  // update this matching too, or a future AI-based parser can replace it.
  let member = "family";
  if (/\b(wife|mom|mommy)\b/.test(lower)) member = "wife";
  else if (/\b(kids?|son|daughter)\b/.test(lower)) member = "kids";
  else if (/\b(for me|my)\b/.test(lower)) member = "me";
...
export default function FamilyCalendar({ currentUser, members, initialTitle }) {
